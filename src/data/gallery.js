/**
 * ЗАПАСНЫЕ ДАННЫЕ. Основной источник — админка (Sanity), см. src/lib/api.js.
 * Этот файл показывается, только если сервис недоступен, — чтобы вместо
 * галереи не было пустой страницы. Отсюда же берутся тексты, пока
 * настройки едут.
 *
